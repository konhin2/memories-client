                                                        ...
                                                        <div className='mt-6 flex justify-between items-center'>
                                                            ...
                                                            </div>
                                                            {
                                                                validation ?
                                                                    (
                                                                        <div>
                                                                            <button className="duration-200 inline-flex items-center justify-center w-10 h-10 mr-4 text-white transition-colors duration-150 bg-memory-c2 rounded-full hover:bg-memory-c1" onClick={(e) => changeEditMode(e)}>
                                                                            ...
                                                                            <Link to='/memories' onClick={(e) => deletePostBtn(e)} type="button" className="duration-200 mr-4 inline-flex items-center p-2 border border-transparent rounded-full shadow-sm text-white bg-memory-c5 hover:bg-memory-c8">
